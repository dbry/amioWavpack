...
public:
    ...
    CAPETagField(const char * pFieldName, const void * pFieldValue, int nFieldBytes = -1, int nFlags = 0);
...
private:
    ...
    CSmartPtr<char> m_spFieldNameUTF16;
...
public:
    ...
    int SetFieldString(const char * pFieldName, const char * pFieldValue);
    int SetFieldString(const char * pFieldName, const char * pFieldValue, BOOL bAlreadyUTF8Encoded);
    int SetFieldBinary(const char * pFieldName, const void * pFieldValue, int nFieldBytes, int nFieldFlags);
    ...
    int GetFieldString(const char * pFieldName, char * pBuffer, int * pBufferCharacters);
