...
#ifndef AMIO_APE_PRIVATE_SETTINGS_H
#define AMIO_APE_PRIVATE_SETTINGS_H

#include "AmioSDK.h"

namespace amio 
{
	class AmioApePrivateSettings
	{
	public:
		AmioApePrivateSettings();
...
#endif AMIO_APE_PRIVATE_SETTINGS_H