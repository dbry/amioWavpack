******************************************************************
 Adobe Audition CS5.5 / CS6 File Filter for WavPack    2015-10-01
...
It will work with Adobe Audition version 4 (also known as CS5.5) and
version 5 (also known as CS6). For other versions of Adobe Audition
or Cool Edit, other plugins are available on the WavPack website.
...
and then restart Audition. Normally, this would be something like one of
these:

C:\Program Files\Adobe\Adobe Audition CS6\Plug-Ins\Amio\
C:\Program Files (x86)\Adobe\Adobe Audition CS5.5\Plug-Ins\Amio\
